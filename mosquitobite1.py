...
Original file is located at
    https://colab.research.google.com/drive/197x_UKMAWiuPSoptwQ2ZE9SP15O8X-cM
"""
...
!python train.py --img 416 --batch 8 --epochs 100 --data coco128.yaml --weights yolov5s.pt --nosave --cache
...
! python detect.py --weights /content/yolov5/runs/train/exp3/weights/last.pt --conf 0.25 --img-size 640 --source /content/Mosquito_Bites.mp4